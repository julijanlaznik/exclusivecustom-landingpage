      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-24 bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-xl text-center relative overflow-hidden">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 md:gap-4 px-6 py-4 md:px-10 md:py-5 bg-black text-white rounded-full hover:bg-brand hover:text-black transition-all duration-300 group shadow-lg"
          >
            ...
            <span className="text-lg md:text-2xl font-bold tracking-tight whitespace-nowrap">+420 774 905 905</span>
          </a>
        </div>
      </div>
    </section>
